  ...
  constructor() {
    this.services = [
      ...
      },
      {
        ...
        url: config.services.email.url,
        endpoint: "/health" // Notre propre service utilise /api/health
      },
      {
        name: "metrics",
  ...
  async sendDiscordNotification(
    ...
    try {
      ...
      const embed: DiscordEmbed = {
        ...
        footer: {
          text: `CRM CRM CREW7892 - Monitoring • ${new Date().toLocaleTimeString("fr-FR", { hour: "2-digit", minute: "2-digit" })}`
        },
        fields: []
      };
